  ...
  getStyles() {
    ...
    return {
      tabItemContainer: {
        ...
        width: '100%',
        height: '48px',
        backgroundColor: '#006699',//themeVariables.backgroundColor,
        whiteSpace: 'nowrap',
        display: 'table',
        borderBottom: '4px #00cccc solid'
      },
    };
  },
  ...
  render() {
    ...
    return (
      <div style={this.mergeAndPrefix(this.props.style)}>
        ...
        <InkBar left={left} width={width} style={this.mergeAndPrefix({
          backgroundColor: 'rgb(0, 159, 173)',//themeVariables.backgroundColor,
        }, this.props.inkBarStyle)}/>
